$(document).ready(function () {
  ...
  const issues = {
    ...
    EMM: [
      "Need to configure work profile in company-provided device",
"Need to configure work profile in personal mobile phone",
"Need to configure Ericsson Teams and Outlook on my mobile device",
"Need to configure personal device in EMM",
"Need to configure Authenticator in mobile",
"Need to set up Erica in mobile phone",
"Need to remove device from EMM",
"Need to activate e-SIM in mobile device",
"Need to set up iOS device",
"Need to reset device PIN code",
"Need to re-register Authenticator",
"Need to order new phone",
"Need the steps to sync company portal",
"Showing error: device non-compliant",
"Need to set up EMM Intune",
"Phone showing non-compliant",
"Need to order SIM",
"Any hardware issue",
"Unable to use Teams and Outlook in company-provided device",
"Unable to use Teams and Outlook in personal device",
"Unable to make calls and attend meetings from mobile Teams",
"Unable to open Teams in mobile device",
"Unable to access applications",
"Unable to sign in",
"Unable to use application after automatic restart",
"Unable to install applications after restore",
...
"Unable to use EMM application inside mobile",
  ...
  const errors = {
    ...
    EMM: [
      "Access blocked",
"Forgot the mobile PIN",
"Sign-in was blocked",
"Wrong password",
"Invalid credentials",
"Password reset isn't turned on for your account",
